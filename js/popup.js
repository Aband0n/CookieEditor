  ...
  chrome.cookies.getAllCookieStores(function(cookieStores) {
    ...
    chrome.cookies.getAll(filterURL, function(cks) {
      ...
      for (var i = 0; i < cks.length; i++) {
        ...
        // BUG : https://bugs.chromium.org/p/chromium/issues/detail?id=1003394
        if (currentC.domain.startsWith(".www")) {
          currentC.domain = currentC.domain.substring(1);
        }
