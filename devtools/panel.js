  ...
  for (var i = 0; i < cookieList.length; i++) {
    ...
    $row.append(
      $("<td/>").append(
        $("<input/>")
          .attr("type", "checkbox")
          .addClass("hostOnlyCB")
          .prop("checked", currentC.hostOnly)
      )
    );
    $row.append(
      $("<td/>").append(
    ...
    $row.append(
      $("<td/>").append(
        $("<input/>")
          .attr("type", "checkbox")
          .prop("checked", currentC.httpOnly)
      )
    );
    ...
    $sameSite.append(
      $("<option/>")
        .attr("value", "no_restriction")
        .attr("i18n", "SameSite_None")
    );
    $sameSite.append(
      $("<option/>")
        .attr("value", "lax")
        .attr("i18n", "SameSite_Lax")
    );
    $sameSite.append(
      $("<option/>")
        .attr("value", "strict")
        .attr("i18n", "SameSite_Strict")
    );
